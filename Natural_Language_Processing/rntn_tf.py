# Implementation of a Recursive Neural Tensor Network in Tensorflow
import sys
...
class RNTN:
    ...
    # list_of_logits is an output; it is added to using post-order traversal
    ...
    def score(self, trees):
        if trees is None:
            ...
            # Just build and run the predict_op for each tree and accumulate the total
            predictions = []
            all_labels = []
