# A simple implementation of a latent semantic analysis
import nltk
import numpy as np
...
for title in titles:
    try:
        title = title.encode('ascii', 'ignore').decode('utf-8')  # this will throw an exception if there are bad characters
...
print("Numbers of errors parsing file:", error_count, "number of lines in file:", len(titles))
