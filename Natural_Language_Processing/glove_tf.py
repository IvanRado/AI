# Implementing GLoVe using TensorFlow
...
from util import get_sentences_with_word2idx_limit_vocab, get_sentences_with_word2idx
...
def main(we_file, w2i_file, use_brown=True, n_files=50):
    ...
    # Checking if we need to re-load the raw data or not
