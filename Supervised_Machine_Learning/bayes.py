# Implementation of the Bayes Classifier on the MNIST dataset
import numpy as np
...
class NaiveBayes(object):
    ...
    def predict(self, X):
        ...
        for c, g in self.gaussians.items():
            ...
            P[:,c] = mvn.logpdf(X, mean=mean, cov = cov) + np.log(self.priors[c]) # Calculate probability of it being from each of the classes
