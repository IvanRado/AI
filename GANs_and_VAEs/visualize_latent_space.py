# Visualization of autoencoder latent space
import util
import numpy as np
...
if __name__ == '__main__':
  ...
  vae.fit(X.copy())
  # Fit will shuffle the data so we need to copy to prevent messing up the order for plotting later, we need Z and Y to correspond
