# Sample application of hierarchical clustering with evolution
# Simplifying assumptions: mutations are only 1 letter changes, single parent is needed for reproduction 
import random
import numpy as np
